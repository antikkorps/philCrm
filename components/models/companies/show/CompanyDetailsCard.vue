...
<template>
    <Card>
        <CardHeader>
            <CardTitle>{{ str($t('company.details.title')).capitalize().value() }}</CardTitle>
            <CardDescription>
        ...
        <CardContent>
            <div class="grid md:grid-cols-2 gap-4">
                <p><span class="text-muted-foreground text-sm">{{ str($t('company.website')).capitalize().value() }} : <br></span>
                ...
                <div>
                    <p><span class="text-muted-foreground text-sm">{{ str($t('company.assignedTo')).capitalize().value() }} :</span> </p>
                ...
                <div>
                    <p><span class="text-muted-foreground text-sm">{{ str($t('company.specialities')).capitalize().value() }} :</span> </p>
                ...
                <p><span class="text-muted-foreground text-sm">{{ str($t('company.address')).capitalize().value() }} :</span> <br>
